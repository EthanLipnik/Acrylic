...
@available(iOS 15.4, macOS 12.3, *)
func makeOutputBlock(graph: MPSGraph, xIn: MPSGraphTensor, embIn: MPSGraphTensor, condIn: MPSGraphTensor, inChannels: NSNumber, outChannels: NSNumber, dHead _: NSNumber, name: String, saveMemory: Bool, spatialTransformer: Bool = true, upsample: Bool = false) -> MPSGraphTensor {
    var x = xIn
...
func tensorToCGImage(data: MPSGraphTensorData) -> CGImage {
    ...
    func Float16(_ value: Float) -> UInt64 {
