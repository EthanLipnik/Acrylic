...
class MeshNode {
    ...
    static func generateElements(width: Int, height: Int, colors: [Color], subdivisions: Int = 18) -> Elements {
...
//        grid[0, 0].color = simd_float3(0.149, 0.275, 0.325)
//        grid[0, 1].color = simd_float3(0.157, 0.447, 0.443)
//        grid[0, 2].color = simd_float3(0.165, 0.616, 0.561)
//
//        grid[1, 0].color = simd_float3(0.541, 0.694, 0.490)
//        grid[1, 1].color = simd_float3(0.914, 0.769, 0.416)
//        grid[1, 2].color = simd_float3(0.937, 0.702, 0.400)
//
//        grid[2, 0].color = simd_float3(0.957, 0.635, 0.380)
//        grid[2, 1].color = simd_float3(0.933, 0.537, 0.349)
//        grid[2, 2].color = simd_float3(0.906, 0.435, 0.318)
        
//        grid[0, 0].color = simd_float3(0.004, 0.047, 0.118)
//        grid[0, 1].color = simd_float3(0.000, 0.118, 0.220)
//        grid[0, 2].color = simd_float3(0.290, 0.427, 0.533)
//
//        grid[1, 0].color = simd_float3(0.000, 0.118, 0.220)
//        grid[1, 1].color = simd_float3(0.004, 0.047, 0.118)
//        grid[1, 2].color = simd_float3(0.000, 0.118, 0.220)
//
//        grid[2, 0].color = simd_float3(0.290, 0.427, 0.533)
//        grid[2, 1].color = simd_float3(0.000, 0.118, 0.220)
//        grid[2, 2].color = simd_float3(0.004, 0.047, 0.118)
//        grid[0, 0].color = simd_float3(1.000, 0.573, 0.282)
//        grid[0, 1].color = simd_float3(1.000, 0.573, 0.282)
//        grid[0, 2].color = simd_float3(1.000, 0.447, 0.286)
//
//        grid[1, 0].color = simd_float3(1.000, 0.325, 0.286)
//        grid[1, 1].color = simd_float3(0.694, 0.196, 0.329)
//        grid[1, 2].color = simd_float3(0.694, 0.196, 0.329)
//
//        grid[2, 0].color = simd_float3(1.000, 0.573, 0.282)
//        grid[2, 1].color = simd_float3(0.969, 0.863, 0.400)
//        grid[2, 2].color = simd_float3(0.180, 0.584, 0.600)
